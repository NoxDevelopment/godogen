...
## The dice tray: dims the page, tumbles 2d6, settles on the rolled pair,
...
## Dice.test(). The tray panel is a bound UI slot ("ui/dice_tray" in
## assets.manifest.json): placeholder leather tint until the Studio asset
## board generates the veritas-ink tray art.
