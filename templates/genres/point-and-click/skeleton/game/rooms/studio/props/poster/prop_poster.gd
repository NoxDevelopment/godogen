...
func _on_click() -> void:
	# Interact: walk to the poster, face it, comment on it.
	await C.player.walk_to_clicked()
	await C.player.face_clicked()
	await C.player.say("A blockout poster. Replace me with generated art.")
...
func _on_right_click() -> void:
	# Look: face the poster from wherever the player stands.
	await C.player.face_clicked()
	await C.player.say("It proves props are clickable in this template.")
